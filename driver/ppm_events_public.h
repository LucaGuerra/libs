...
#define PPM_SC_FIELDS \
	...
	PPM_SC_X(MAP_SHADOW_STACK, 401) \
	PPM_SC_X(MSEAL, 402) \
	PPM_SC_X(FUTEX_WAIT, 403) \
	PPM_SC_X(S390_GUARDED_STORAGE, 404) \
	PPM_SC_X(SWITCH_ENDIAN, 405) \
	PPM_SC_X(SUBPAGE_PROT, 406) \
	PPM_SC_X(SYS_DEBUG_SETCONTEXT, 407) \
	PPM_SC_X(SIGSUSPEND, 408) \
	PPM_SC_X(S390_PCI_MMIO_READ, 409) \
	PPM_SC_X(FUTEX_REQUEUE, 410) \
	PPM_SC_X(FUTEX_WAKE, 411) \
	PPM_SC_X(PCICONFIG_READ, 412) \
	PPM_SC_X(LISTMOUNT, 413) \
	PPM_SC_X(SPU_CREATE, 414) \
	PPM_SC_X(OLDFSTAT, 415) \
	PPM_SC_X(LSM_GET_SELF_ATTR, 416) \
	PPM_SC_X(LSM_SET_SELF_ATTR, 417) \
	PPM_SC_X(READDIR, 418) \
	PPM_SC_X(URETPROBE, 419) \
	PPM_SC_X(SIGACTION, 420) \
	PPM_SC_X(VM86, 421) \
	PPM_SC_X(STATMOUNT, 422) \
	PPM_SC_X(OLDOLDUNAME, 423) \
	PPM_SC_X(RISCV_FLUSH_ICACHE, 424) \
	PPM_SC_X(RISCV_HWPROBE, 425) \
	PPM_SC_X(CACHESTAT, 426) \
	PPM_SC_X(OLDSTAT, 427) \
	PPM_SC_X(TIMERFD, 428) \
	PPM_SC_X(SPU_RUN, 429) \
	PPM_SC_X(FCHMODAT2, 430) \
	PPM_SC_X(SYNC_FILE_RANGE2, 431) \
	PPM_SC_X(S390_STHYI, 432) \
	PPM_SC_X(MULTIPLEXER, 433) \
	PPM_SC_X(LSM_LIST_MODULES, 434) \
	PPM_SC_X(RTAS, 435) \
	PPM_SC_X(PCICONFIG_IOBASE, 436) \
	PPM_SC_X(SWAPCONTEXT, 437) \
	PPM_SC_X(SIGRETURN, 438) \
	PPM_SC_X(S390_RUNTIME_INSTR, 439) \
	PPM_SC_X(S390_PCI_MMIO_WRITE, 440) \
	PPM_SC_X(PCICONFIG_WRITE, 441) \
	PPM_SC_X(OLDLSTAT, 442)
