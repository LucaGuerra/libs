...
#define PPM_SC_FIELDS \
	...
	PPM_SC_X(SPU_CREATE, 401) \
	PPM_SC_X(TIMERFD, 402) \
	PPM_SC_X(OLDFSTAT, 403) \
	PPM_SC_X(SWAPCONTEXT, 404) \
	PPM_SC_X(SYS_DEBUG_SETCONTEXT, 405) \
	PPM_SC_X(S390_PCI_MMIO_READ, 406) \
	PPM_SC_X(RISCV_HWPROBE, 407) \
	PPM_SC_X(SWITCH_ENDIAN, 408) \
	PPM_SC_X(PCICONFIG_READ, 409) \
	PPM_SC_X(FUTEX_REQUEUE, 410) \
	PPM_SC_X(FCHMODAT2, 411) \
	PPM_SC_X(SIGSUSPEND, 412) \
	PPM_SC_X(RTAS, 413) \
	PPM_SC_X(FUTEX_WAIT, 414) \
	PPM_SC_X(OLDSTAT, 415) \
	PPM_SC_X(S390_RUNTIME_INSTR, 416) \
	PPM_SC_X(S390_GUARDED_STORAGE, 417) \
	PPM_SC_X(PCICONFIG_IOBASE, 418) \
	PPM_SC_X(MULTIPLEXER, 419) \
	PPM_SC_X(SPU_RUN, 420) \
	PPM_SC_X(RISCV_FLUSH_ICACHE, 421) \
	PPM_SC_X(FUTEX_WAKE, 422) \
	PPM_SC_X(READDIR, 423) \
	PPM_SC_X(S390_STHYI, 424) \
	PPM_SC_X(S390_PCI_MMIO_WRITE, 425) \
	PPM_SC_X(MAP_SHADOW_STACK, 426) \
	PPM_SC_X(VM86, 427) \
	PPM_SC_X(SIGRETURN, 428) \
	PPM_SC_X(SIGACTION, 429) \
	PPM_SC_X(SYNC_FILE_RANGE2, 430) \
	PPM_SC_X(CACHESTAT, 431) \
	PPM_SC_X(OLDLSTAT, 432) \
	PPM_SC_X(PCICONFIG_WRITE, 433) \
