...
typedef struct scap_open_args
{
	...
	const char *runsc_root_path; ///< When using gVisor, use this to configure the root path of runsc 
	const char *trace_session_config_path; ///< When using gVisor, use this to configure the path to the config for trace sessions 
