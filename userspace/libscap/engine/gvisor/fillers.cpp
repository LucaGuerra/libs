...
int32_t fill_event_fork_20_e(scap_sized_buffer scap_buf, size_t* event_size, char* scap_err) {
	return scap_event_encode_params(scap_buf, event_size, scap_err, PPME_SYSCALL_FORK_20_E, 0);
}
...
int32_t fill_event_vfork_20_e(scap_sized_buffer scap_buf, size_t* event_size, char* scap_err) {
	return scap_event_encode_params(scap_buf, event_size, scap_err, PPME_SYSCALL_VFORK_20_E, 0);
}
...
int32_t fill_event_close_e(scap_sized_buffer scap_buf,
                           ...
                           char* scap_err,
                           int64_t fd) {
	return scap_event_encode_params(scap_buf, event_size, scap_err, PPME_SYSCALL_CLOSE_E, 1, fd);
}
...
int32_t fill_event_close_x(scap_sized_buffer scap_buf,
                           ...
                           char* scap_err,
                           int64_t res) {
	return scap_event_encode_params(scap_buf, event_size, scap_err, PPME_SYSCALL_CLOSE_X, 1, res);
}
...
int32_t fill_event_readv_e(scap_sized_buffer scap_buf,
                           ...
                           char* scap_err,
                           int64_t fd) {
	return scap_event_encode_params(scap_buf, event_size, scap_err, PPME_SYSCALL_READV_E, 1, fd);
}
...
int32_t fill_event_pipe_e(scap_sized_buffer scap_buf, size_t* event_size, char* scap_err) {
	return scap_event_encode_params(scap_buf, event_size, scap_err, PPME_SYSCALL_PIPE_E, 0);
}
